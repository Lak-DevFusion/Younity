...
export const HaveMessage = async (cities, category, bot, msg) => {
  try {
    ...
    // Filter communities based on the selected cities
    ...
    // Create the list of communities with their prices
    ...
    // Ask the user to select communities by number
    await bot.sendMessage(
      chatId,
    ...
    // Extract only the community names from the selected communities
